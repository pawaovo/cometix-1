...
/// @nodoc
mixin _$Message {
  String get role => throw _privateConstructorUsedError; // 'user' or 'model'
...
class _$MessageImpl implements _Message {
  const _$MessageImpl({required this.role, required this.text});
