                ...
                children: [
                  SectionGroup(
                    ...
                    children: [
                      ToggleItem(
                        label: '聊天记录',
                        checked: _chatHistory,
                        onChange: (v) => setState(() => _chatHistory = v),
                      ),
                      ToggleItem(
                        label: '文件',
                        checked: _files,
                        onChange: (v) => setState(() => _files = v),
                      ),
                    ],
                  ),
                  const SizedBox(height: 16),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            SettingsHeader(title: '聊天存储', onBack: onBack),
            Expanded(
              child: Center(
                child: Column(
